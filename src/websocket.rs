...
mod tests {
    ...
    fn test_check_ws() {
        ...
        // assert_eq!(check_ws("127.0.0.1:1115"), "ws://127.0.0.1:1118");
        // assert_eq!(check_ws("127.0.0.1:1116"), "ws://127.0.0.1:1118");
        // assert_eq!(check_ws("127.0.0.1:1117"), "ws://127.0.0.1:1119");
        // assert_eq!(check_ws("rd.com:1115"), "ws://rd.com/ws/id");
        // assert_eq!(check_ws("rd.com:1116"), "ws://rd.com/ws/id");
        // assert_eq!(check_ws("rd.com:1117"), "ws://rd.com/ws/relay");
        // set relay-server without port
        Config::set_option("relay-server".to_string(), "127.0.0.1".to_string());
        Config::set_option(
            "api-server".to_string(),
            "https://api.rd.com".to_string(),
        );
        assert_eq!(
            check_ws("[0:0:0:0:0:0:0:1]:1115"),
            "ws://[0:0:0:0:0:0:0:1]:1118"
        );
        assert_eq!(
            check_ws("[0:0:0:0:0:0:0:1]:1116"),
            "ws://[0:0:0:0:0:0:0:1]:1118"
        );
        assert_eq!(
            check_ws("[0:0:0:0:0:0:0:1]:1117"),
            "ws://[0:0:0:0:0:0:0:1]:1119"
        );
        assert_eq!(check_ws("rd.com:1115"), "wss://rd.com/ws/id");
        assert_eq!(check_ws("rd.com:1116"), "wss://rd.com/ws/id");
        assert_eq!(
            check_ws("rd.com:1117"),
            "wss://rd.com/ws/relay"
        );
        // set relay-server with default port
        Config::set_option("relay-server".to_string(), "127.0.0.1:1117".to_string());
        assert_eq!(check_ws("127.0.0.1:1115"), "ws://127.0.0.1:1118");
        assert_eq!(check_ws("127.0.0.1:1116"), "ws://127.0.0.1:1118");
        assert_eq!(check_ws("127.0.0.1:1117"), "ws://127.0.0.1:1119");
